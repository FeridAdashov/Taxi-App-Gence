...
//    }
    ...
    public void setListener(OnMenuChangeListener listener) {
        ...
        for (final Item item : getItems()) {
            item.getView().setOnClickListener(v -> {
                ...
                if (layout != null) layout.collapse(true);
            });
            item.getView().setOnLongClickListener(v -> {
                isLongClick = true;
                Log.e("FilterMenu", "onLongClick");
                if (getListener() != null) {
                    getListener().onMenuItemLongClick(item.getView(), item.getPosition());
                }
                return false;
            });
        }
    ...
    public interface OnMenuChangeListener {
        ...
        void onMenuItemLongClick(View view, int position);
