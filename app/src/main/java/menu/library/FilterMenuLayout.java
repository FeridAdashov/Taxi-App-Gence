...
public class FilterMenuLayout extends ViewGroup {
     ...
     */
    public int centerLeft, centerRight, centerTop, centerBottom;
    /**
    ...
    private void init(Context ctx, AttributeSet attrs) {
        ...
        int mDrawable = ta.getResourceId(R.styleable.FilterMenuLayout_fm_drawable, R.drawable.ic_fragments);
        ta.recycle();
        ...
        if (Build.VERSION.SDK_INT >= 21) outlineProvider = new OvalOutline();
        drawable = new FilterMenuDrawable(ctx, Color.WHITE, collapsedRadius, mDrawable);
        menuBounds = new Rect();
        ...
        colorAnimator.addUpdateListener(animation -> primaryDarkPaint.setColor((Integer) animation.getAnimatedValue()));
