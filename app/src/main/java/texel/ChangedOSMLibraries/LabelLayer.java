...
public class LabelLayer extends Layer implements Map.UpdateListener, TileManager.Listener,
    ...
    static final Logger log = LoggerFactory.getLogger(org.oscim.layers.tile.vector.labeling.LabelLayer.class);

    static final String LABEL_DATA = org.oscim.layers.tile.vector.labeling.LabelLayer.class.getName();
