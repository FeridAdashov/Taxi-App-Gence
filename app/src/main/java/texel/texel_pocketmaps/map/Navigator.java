...
public class Navigator {
     ...
     */
    private boolean on;
    private final List<NavigatorListener> listeners;
     ...
     */
    public String getDistanceByStringWithUnit(Instruction distance) {
     ...
     */
    public String getDistanceByStringWithUnit() {
    ...
    public double getDistance() {
        if (getGhResponse() == null) return 0.;
