...
public class JsonWrapper {
    ...
    public void put(String key, boolean v) throws JSONException {
        obj.put(key, v);
    }

    public void put(String key, int v) throws JSONException {
        obj.put(key, v);
    }

    public void put(String key, Object v) throws JSONException {
        obj.put(key, v);
    }
