...
public class LightSensor implements SensorEventListener {
    ...
    private void setLight(Brightness b) {
        ...
        if (b != Brightness.USER) {
            ...
            float newValue = -1.0f;
            if (b == Brightness.DARK && lp.screenBrightness != 0.0f) {
                newValue = 0.0f;
            } else if (b == Brightness.MID && lp.screenBrightness != 0.5f) {
                newValue = 0.5f;
            } else if (b == Brightness.LIGHT && lp.screenBrightness != 1.0f) {
                newValue = 1.0f;
            }
            if (newValue != -1) {
